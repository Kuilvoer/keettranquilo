...
// ===== QUESTIONS =====
const questions = [
  { questionText: 'welke kleur is blauw?', options: ['blauw', 'rood', 'groen', 'geel'], correctIndex: 1, image: 'images/Afbeelding1.jpg' },
  { questionText: 'wie is de mol', options: ['roben', 'reben', 'ruben', 'raben'], correctIndex: 2, image: 'images/Afbeelding2.jpg' },
  { questionText: 'van wie is de uitspraak {ik ben zo blauw als een pauw?}', options: ['sven', 'jens', 'stan', 'marijn'], correctIndex: 2, image: 'images/Afbeelding3.jpg' },
  { questionText: 'wanneer is Keet Tranquillo opgericht?', options: ['2016', '2017', '2018', '2015'], correctIndex: 1, image: 'images/Afbeelding4.jpg' },
  { questionText: 'wat is de aller eerste plek van de keet', options: ['Bij wesley', 'bij Nick en Mart', 'Bij Stan', 'Bij Ruben'], correctIndex: 3, image: 'images/Afbeelding5.jpg' },
  { questionText: 'wie sloeg er met een bier pull iemands kop in in zaal dijk?', options: ['Stan', 'Jari', 'Sven Hoes', 'Ruben'], correctIndex: 3, image: 'images/Afbeelding6.jpg' },
  { questionText: 'Wat is een Tomaat?', options: ['Groente', 'Reptiel', 'Fruit', 'Kaapies liefde'], correctIndex: [2, 3], image: 'images/Afbeelding7.jpg' },
  { questionText: 'wie zaagde er bij oud en nieuw bij de keet een boom om?', options: ['Nick', 'Jorry', 'Ingmar', 'Marijn'], correctIndex: 2, image: 'images/Afbeelding8.jpg' },
  { questionText: 'wat is Joris van Luca', options: ['Zijn oom', 'Zijn neef', 'De Pukkel Van nina', 'Luca Junior'], correctIndex: 3, image: 'images/Afbeelding9.jpg' },
  { questionText: 'Jorry is de oudste van de keet', options: ['Waar', 'Niet waar'], correctIndex: 0, image: 'images/Afbeelding10.jpg' },
  { questionText: 'wie heeft er vanaf april tot en met september geen weekend rust door zijn/haar volle planning 🔑 ?', options: ['Nick', 'Bas', 'Jens', 'lieke'], correctIndex: 2, image: 'images/Afbeelding11.jpg' },
  { questionText: 'over wie spreken we als het gaat om de uitspraak {veel vermogend}', options: ['Romy', 'Wesley', 'Bas', 'Bas'], correctIndex: [2, 3], image: 'images/Afbeelding12.jpg' },
  { questionText: 'Wie is er op Mallorca van een Muurtje afgevallen en daar in slaap gevallen?', options: ['Ruben', 'Lisa', 'Sven', 'Stan'], correctIndex: 3, image: 'images/Afbeelding13.jpg' },
  { questionText: 'hoe heet de snackbar op Terschelling?', options: ['de schotse 4', 'WYB', 'het stoepje', 'De clipper'], correctIndex: 3, image: 'images/Afbeelding14.jpg' },
  { questionText: 'wie is de jongste van de Keet?', options: ['Lisa', 'Renee', 'Romy', 'Paula'], correctIndex: 0, image: 'images/Afbeelding15.jpg' },
  { questionText: 'Hoeveel cijfers telt Tranquillo?', options: ['6', '10', '0', '8'], correctIndex: 2, image: 'images/Afbeelding16.jpg' },
  { questionText: 'Wie is Gerard Glans?', options: ['Neef van Ron Jans', 'Personage uit de Dreft reclame', 'Gerard Reins en Robert Lans', 'Hardloper bij AV PEC-1910'], correctIndex: 2, image: 'images/Afbeelding17.jpg' },
  { questionText: 'Hoeveel dagen Heeft Augustus?', options: ['30', '29', '31', '28'], correctIndex: 2, image: 'images/Afbeelding18.jpg' },
  { questionText: 'Wat verzamelen we altijd na een vakantie in het buitenland?', options: ['Soa\'s', 'geld voor een goed doel', 'Kaapies', 'herinneringen'], correctIndex: 2, image: 'images/Afbeelding19.jpg' },
  { questionText: '1000x 25-250=24750', options: ['Waar', 'Niet waar'], correctIndex: 0, image: 'images/Afbeelding20.jpg' },
  { questionText: 'wanneer begon corona?', options: ['April 2019', 'februari 2020', 'Maart 2021', 'December 2019'], correctIndex: 1, image: 'images/Afbeelding21.jpg' },
  { questionText: 'Welke Dame zit er het langste Bij de groep', options: ['Romy', 'Aicha', 'Reneé', 'lieke'], correctIndex: 0, image: 'images/Afbeelding22.jpg' },
  { questionText: 'Wat kregen we bij Vonnie thuis na hem thuis te hebben gebracht met een kruiwagen?', options: ['Tosti', 'Magnum', 'Pepernoten', 'Broodje Bapao'], correctIndex: 3, image: 'images/Afbeelding23.jpg' },
  { questionText: 'Wie heeft er vaak na of tijdens een avond drinken last van zijn pens', options: ['Marijn', 'Iwan', 'Robert', 'Bas'], correctIndex: 3, image: 'images/Afbeelding24.jpg' },
  { questionText: 'Wie Had er vroeger een crush op {Noukie}', options: ['Ruben', 'Iwan', 'Luca', 'Wesley'], correctIndex: 1, image: 'images/Afbeelding25.jpg' },
  { questionText: 'Wie krijgt er als eerst de Keet baby?', options: ['Sven en Romy', 'Nick en Reneé', 'Marijn en Lisa', 'Luca {en zijn balkan hoer}'], correctIndex: [0, 1, 2, 3], image: 'images/Afbeelding26.jpg' },
  { questionText: 'Wie is [Zijn} er na een avondje dijk bij bureau halt belandt?', options: ['Nick', 'jens', 'Sven', 'Mart'], correctIndex: [0, 1, 2, 3], image: 'images/Afbeelding27.jpg' },
  { questionText: 'wie is het leukste zus{je}', options: ['Kyra', 'Nina', 'Demi', 'jill'], correctIndex: [0, 1, 2, 3], image: 'images/Afbeelding28.jpg' },
  { questionText: 'Wie belde zijn vriendin voordat die de stripclub in ging?', options: ['Ingmar', 'Bas', 'Jari', 'Sven'], correctIndex: 0, image: 'images/Afbeelding29.jpg' },
  { questionText: 'waar staat denekamp bekend om', options: ['sociale huur woningen', 'cafe\'s', 'watermolens', 'grachten'], correctIndex: 2, image: 'images/Afbeelding30.jpg' },
  { questionText: 'je kan niet met je ogen open niezen', options: ['Waar', 'Niet waar'], correctIndex: 0, image: 'images/Afbeelding31.png' },
  { questionText: 'wat is 53 x 83', options: ['4299', '499', '4399', '4499'], correctIndex: 2, image: 'images/Afbeelding32.png' }
];
